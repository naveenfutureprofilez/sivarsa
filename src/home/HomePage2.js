...
export function WEBDEV(){
  return <div className={` overflow-hidden thumbnailBox h-full relative bg-[#6FF04A] `}>
      <div className="wall text-white p-2 sm:p-3 md:p-4 lg:p-6 ">       
        ...
        <p className="font-GoshaSans  text-sm sm:text-sm md:text-base lg:text-lg xl:text-xl leading-none text-[#0B6222]">Unleash the power of AI to <br /> transform your business</p>
