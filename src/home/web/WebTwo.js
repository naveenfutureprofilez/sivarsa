...
export function Uptime(){
    return <>
      <div className={`thumbnailBox h-full relative  bg-[#C0E143] `}>
          ...
          <div className="md:absolute md:right-[30px] text-[#0B6222] text-lg lg:text-xl font-GoshaSans md:bottom-[20px]  xl:bottom-[40px] md:text-right">Uptime <br className="hidden md:block"></br> Guaranteed</div>
      </div>
      </div>
    </>
  } 
