...
import { SKILL, SKILL_CATEGORY_1, SKILL_CATEGORY_2, SKILL_CATEGORY_3, SKILL_CATEGORY_4, AI_TAP } from "../../home/AI/AIThree";
  ...
  const [flipDirection, setFlipDirection] = useState(direction);
    ...
    const [rotate, setRotate] = useState(false);
     ...
     const handleNext = () => {
        ...
        navigate("/services/ai/4");
      };

      const handlePrev = () => {
        setDirection('vertical');
        setRotate(prevRotate => !prevRotate);
        navigate("/services/ai/2");
      };
