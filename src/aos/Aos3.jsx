   ...
   useEffect(()=>{
    ...
    return (
      <div className="grid w-full overflow-hidden h-screen gap-1 grid-cols-3 grid-rows-custome bg-black">
        <div data-aos="zoom-out" className="thumbnailBox h-full bg-[#6FF04A] ">
        ...
        <Link to="/aos2" className="relative thumbnailBox h-full bg-[#171717] p-2 sm:p-3 md:p-4 lg:p-6 ">
          ...
          <div data-aos="zoom-out" className="thumbnailBox h-full bg-[#171717] p-2 sm:p-3 md:p-4 lg:p-6  relative">
