...
export default function Aos2() {
   useEffect(()=>{
    ...
    return (
      <div className="grid w-full overflow-hidden  h-screen gap-1 grid-cols-3 grid-rows-custome bg-black">
        <div data-aos="zoom-in" className="thumbnailBox h-full bg-[#FF7E2D] ">
            <div className="text-white left p-2 sm:p-3 md:p-4 lg:p-6 bg-[#FF7E2D]">       
   ...
   <div className="absolute absolute  bottom-2 xm:bottom-4 md:bottom-5 lg:bottom-7 xl:bottom-8 right-2 sm:right-4 md:right-5 lg:right-7 xl:right-8" dangerouslySetInnerHTML={{ __html: arrowblackUP }}></div>
        ...
        <Link to="/aos1" className="relative thumbnailBox h-full bg-[#171717] p-2 sm:p-3 md:p-4 lg:p-6 ">
          ...
          <Link to="/aos3" className="relative thumbnailBox h-full bg-[#171717] p-2 sm:p-3 md:p-4 lg:p-6 ">
